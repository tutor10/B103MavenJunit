...
//      Ay Secimi
        ...
        monthDropdown.selectByValue("0");//option in value degeri ile secim yapilabilir. January seceneinin value si 0
...
//       State dropdownindaki varsayilan secili secenegin 'Select a State' oldugunu verify edelim
        ...
        String varsayilanText = stateDropdown.getFirstSelectedOption().getText();//bu daha makul WebElement methoduna gore
