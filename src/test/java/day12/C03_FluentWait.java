...
//        Hello World! Yazının sitede oldugunu test et
        ...
        // 1.Fluent Wait icin bir obje olustur.-EXPLICIT WAIT TEN FARKI BU KISIM-
        Wait<WebDriver> wait = new FluentWait<>(driver)
                .withTimeout(Duration.ofSeconds(30))//MAX BEKLEME SURESI
                .pollingEvery(Duration.ofSeconds(3))//DENEME ARALIKLARI
                .withMessage("IGNORE EXCEPTION")//MESAJ YAZABILIRIM.ZORUNLU DEGIL
                .ignoring(NoSuchMethodException.class);//EXCEPTION'I IGNORE-HANDLE ET
